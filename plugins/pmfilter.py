...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        try:
            ...
            if await db.has_premium_access(user_id):                               
                buttons = [[
                    ...
                    InlineKeyboardButton('📌 ᴊᴏɪɴ Main ᴄʜᴀɴɴᴇʟ 📌', url='https://t.me/actanimemm')
                ]]
            else:
    ...
    # don't change anything without contacting me @cryxelys
        ...
        buttons = [[
            InlineKeyboardButton('× Mian Channel ×', url="https://t.me/actanimemm")
       ],[
            InlineKeyboardButton('• ɢʀᴏᴜᴘ •', url="t.me/+MiZPQEVy7htkMGZl"),
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs •', url="t.me/act_Privacy")
       ],[
            InlineKeyboardButton('• ACTOFFICIAL•', url="https://t.me/actanimemmofficial"),
            InlineKeyboardButton('• ACT Ongoing •', url="https://t.me/actong")
       ],[
            InlineKeyboardButton('• ACT Anime MM •', url="https://t.me/actanimemm")
       ],[ 
            InlineKeyboardButton('◁ ʙᴀᴄᴋ', callback_data='start')
        ]]
        await client.edit_message_media(
